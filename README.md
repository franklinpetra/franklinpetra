...
- 🎓 &nbsp; Recently graduated from the bootcamp, "Coding Dojo", which means I can now build efficient (albeit a bit plain vanilla) full-stack applications in Python, C#, and JavaScript.   
